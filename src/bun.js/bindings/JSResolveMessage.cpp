...
extern "C" JSC::EncodedJSValue ResolveMessage__getMessage(void* resolveMessage, JSC::JSGlobalObject*);
...
JSC_DEFINE_CUSTOM_GETTER(jsResolveMessageGetter_code, (JSGlobalObject * globalObject, JSC::EncodedJSValue thisValue, PropertyName))
{
    ...
    void* resolveMessage = Bun__getResolveMessage(errorInstance->bunErrorData());
    if (!resolveMessage)
        return JSC::JSValue::encode(jsUndefined());
...
extern "C" JSC::EncodedJSValue ResolveMessage__toJS(void* resolveMessage, JSC::JSGlobalObject* globalObject)
{
    ...
    JSC::JSValue messageValue = JSC::JSValue::decode(ResolveMessage__getMessage(resolveMessage, globalObject));
    WTF::String message = messageValue.isString() ? messageValue.toWTFString(globalObject) : WTF::String();
