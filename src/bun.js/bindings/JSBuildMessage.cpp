...
extern "C" JSC::EncodedJSValue BuildMessage__getMessage(void* buildMessage, JSC::JSGlobalObject*);
...
JSC_DEFINE_CUSTOM_GETTER(jsBuildMessageGetter_level, (JSGlobalObject* globalObject, JSC::EncodedJSValue thisValue, PropertyName))
{
    ...
    void* buildMessage = Bun__getBuildMessage(errorInstance->bunErrorData());
    if (!buildMessage)
        return JSC::JSValue::encode(jsUndefined());
...
extern "C" JSC::EncodedJSValue BuildMessage__toJS(void* buildMessage, JSC::JSGlobalObject* globalObject)
{
    ...
    JSC::JSValue messageValue = JSC::JSValue::decode(BuildMessage__getMessage(buildMessage, globalObject));
